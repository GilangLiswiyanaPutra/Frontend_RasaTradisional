...
import kupatglabedFoto from '../../../assets/tegal/makanan/kupatglabed/kupatglabed.png'
import kupatglabedFoto2 from '../../../assets/tegal/makanan/kupatglabed/kupatglabed2.png'
import kupatglabedToko1 from '../../../assets/tegal/makanan/kupatglabed/toko1.png'
import kupatglabedToko2 from '../../../assets/tegal/makanan/kupatglabed/toko2.png'
import kupatglabedOrang1 from '../../../assets/tegal/makanan/orang1.png'
...
<div>
    ...
    <Image src={Back} />
       ...
       <Image className="imgHead3" src={kupatglabedFoto} />
      </div>
      <div class="description">
        <section>
          ...
          <p>Kupat glabed adalah sajian yang terdiri dari
             ketupat dan kuah kuning ‘glabed’. Salah satu 
             ciri khas kupat glabed adalah adanya taburan
              kerupuk kuning yang menggunung di atasnya. 
              Kupat glabed juga disajikan bersama suwiran
               halus daging ayam yang bercita rasa gurih. 
               Untuk harganya pun terbilang murah, yakni 
               sekitar Rp 5 ribu sampai Rp 15 ribuan saja 
               saja per porsinya. </p>
        ...
        <section class="penyajian">
          <div>
          <Image src={kupatglabedFoto2} />
            
          </div>
          <div>
            <h1>Penyajian</h1>
            <p>Dalam penyajian kupat glabed komplet, ketupat
                 dipotong-potong, ditaruh di piring, lalu diguyur 
                 sayur tempe kuah kuning, diberi taburan bawang 
                 goreng, sambal merah, dan topping remahan kerupuk
                  mi kuning. Lalu kupat glabed disajikan dengan
                   gorengan dan aneka sate yang bisa dipilih 
                   sesuai selera.</p>
          </div>
        </section>
        ...
        <section class="tersedia">
          ...
          <div class="imgTersedia2">
           ...
           <a href="/kupatglabed1">
            <Image  src={kupatglabedToko1} />
            </a>
            <a href="/kupatglabed2">
            <Image  src={kupatglabedToko2} /></a> </div>
            <br/><br/>
            <br/>
