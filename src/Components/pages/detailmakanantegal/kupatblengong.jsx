...
import kupatblengongFoto from '../../../assets/tegal/makanan/kupatblengong/kupatblengong.png'
import kupatblengongFoto2 from '../../../assets/tegal/makanan/kupatblengong/kupatblengong2.png'
import kupatblengongToko1 from '../../../assets/tegal/makanan/kupatblengong/toko1.png'
import kupatblengongToko2 from '../../../assets/tegal/makanan/kupatblengong/toko2.png'
import kupatblengongOrang1 from '../../../assets/tegal/makanan/orang1.png'
...
<div>
    ...
    <Image src={Back} />
       ...
       <Image className="imgHead3" src={kupatblengongFoto} />
      </div>
      <div class="description">
        <section>
          <div class="judul">
            <h1>Kupat Blengong</h1>
          ...
          <p>Kupat Blengong sebenarnya adalah Kupat Glabeb
             yang dilengkapi dengan tambahan Sate Blengong. 
             Terbuat dari daging Blengong, sate yang memiliki ukuran 
             relatif lebih panjang daripada sate pada umumnya ini bercita 
             rasa gurih. Soal tekstur, daging blengong sendiri memiliki rasa
              yang menyerupai daging bebek. </p>
 
        </section>
       
        <section class="penyajian">
          <div>
          <Image src={kupatblengongFoto2} />
            
          </div>
          <div>
            <h1>Penyajian</h1>
            <p>Kupat blengong disajikan dalam sepiring ketupat yang 
                diberi kuah agak kental dan dimakan bersama dengan sate 
                blengong atau daging blengong. Untuk sambalnya disajikan
                 dengan cara diulek pada saat awal memesan, jadi bukan sambal
                  jadi. Kuliner ini sudah ada di Tegal, sejak setengah abad 
                  lalu.</p>
          </div>
        </section>
        ...
        <section class="tersedia">
          ...
          <div class="imgTersedia2">
           ...
           <a href="/kupatblengong1">
            <Image  src={kupatblengongToko1} />
            </a>
            <a href="/kupatblengong2">
            <Image  src={kupatblengongToko2} /></a> </div>
            <br/><br/>
            <br/>
