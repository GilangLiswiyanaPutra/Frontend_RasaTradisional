...
import olosFoto from '../../../assets/tegal/makanan/olos/kupat.png'
import olosFoto2 from '../../../assets/tegal/makanan/olos/penyajian.png'
import olosToko1 from '../../../assets/tegal/makanan/olos/Group254.png'
import olosToko2 from '../../../assets/tegal/makanan/olos/Group255.png'
import orangOlos1 from '../../../assets/tegal/makanan/olos/orang1.png'
import orangOlos2 from '../../../assets/tegal/makanan/olos/orang2.png'
    ...
    <Image src={Back} />
      ...
      <div class="description">
        <section>
          ...
          <p>Gorengan yang terbuat dari bahan 
            tepung terigu dengan isian sayur-sayuran dan 
            cabai ini menjadi salah satu kuliner khas Tegal
             yang cukup digemari. Apalagi, kini Olos sudah
              dimodifikasi dengan beragam isian seperti sosis,
               ayam, dan juga keju. Identik dengan rasa pedas,
                jelas makanan khas Tegal satu ini wajib dicicipi
                 jika kamu merupakan penggemar makanan pedas. </p>
        ...
        <section class="penyajian">
          ...
          <div>
            <h1>Penyajian</h1>
            <p>Olos merupakan salah satu jajanan khas Tegal yang dibuat dari tepung aci/kanji yang dikombinasikan dengan tepung terigu dan diberi isian. Olos original versi klasik khaskota Tegal Brebes Jawa Tengah untuk isian biasanya berupa tumisan kol, daun bawangdan irisan cabai rawit. Namun selain berisi isian tersebut, kini olos dapat di kreasikandengan aneka bahan lainnya. Seperti ditambahkan sayuran wortel layaknya gorenganbakwan, kornet, sosis, daging cincang dan lain sebagainya</p>
          </div>
        </section>
