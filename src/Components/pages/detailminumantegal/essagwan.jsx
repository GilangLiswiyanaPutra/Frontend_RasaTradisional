...
import essagwanFoto from '../../../assets/tegal/minuman/essagwan/essagwan.png'
import essagwanFoto2 from '../../../assets/tegal/minuman/essagwan/essagwan2.png'
import essagwanToko1 from '../../../assets/tegal/minuman/essagwan/toko1.png'
import essagwanToko2 from '../../../assets/tegal/minuman/essagwan/toko2.png'
import essagwanOrang1 from '../../../assets/tegal/minuman/orang1.png'
...
<div>
    ...
    <Image src={Back} />
       ...
       <Image className="imgHead3" src={essagwanFoto} />
      </div>
      <div class="description">
        <section>
          ...
          <p> Es Sagwan adalah minuman tradisional yang berasal dari Tegal,
             Jawa Tengah, Indonesia. Nama "Sagwan" berasal dari bahasa 
             Jawa yang berarti "sejuk" atau "dingin", merujuk pada sensasi
              menyegarkan yang dihasilkan oleh minuman ini.
Proses pembuatan Es Sagwan dimulai dengan bahan dasar utamanya, yaitu 
sagu mutiara yang telah direbus hingga matang dan mengembang. Sagu mutiara 
ini kemudian disaring untuk memisahkan air rebusan, sehingga hanya butiran 
sagu yang diambil untuk disajikan.</p>
 
        </section>
       
        <section class="penyajian">
          <div>
          <Image src={essagwanFoto2} />
            
          </div>
          <div>
            <h1>Penyajian</h1>
            <p>Proses pembuatan es sagwan meliputi rendaman dan
                 perebusan sagu mutiara hingga lunak, penyajian
                  dalam mangkuk dengan tambahan gula, santan 
                  (opsional), dan sirup atau buah segar sebagai
                   pelengkap, lalu disajikan dengan es batu.</p>
          </div>
        </section>
        ...
        <section class="tersedia">
          ...
          <div class="imgTersedia2">
           ...
           <a href="/essagwan2">
            <Image  src={essagwanToko1} />
            </a>
            <a href="/essagwan2">
            <Image  src={essagwanToko2} /></a> </div>
            <br/><br/>
            <br/>
            <br/>
            <br/>
