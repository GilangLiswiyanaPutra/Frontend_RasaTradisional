...
import pisangplenetFoto from '../../../assets/semarang/makanan/pisangplenet/pisangplenet1.png'
import pisangplenetFoto2 from '../../../assets/semarang/makanan/pisangplenet/pisangplenet2.png'
import pisangplenetToko1 from '../../../assets/semarang/makanan/pisangplenet/toko1.png'
import pisangplenetToko2 from '../../../assets/semarang/makanan/pisangplenet/toko2.png'
...
<div>
    ...
    <Image src={Back} />
       ...
       <Image className="imgHead3" src={pisangplenetFoto} />
      </div>
      <div class="description">
        <section>
          <div class="judul">
            <h1>Pisang Plenet</h1><div className="nilaibintang">
          ...
          <p>Pisang Plenet Semarang adalah varian dari hidangan Pisang Plenet yang khas dari daerah Semarang, Jawa Tengah, Indonesia. Hidangan ini memiliki ciri khas tersendiri yang membedakannya dari versi lainnya.
Hidangan ini seringkali disajikan sebagai makanan ringan atau camilan di berbagai acara, mulai dari arisan hingga acara keluarga. Rasanya yang manis, gurih, dan lezat membuat Pisang Plenet Semarang menjadi camilan favorit bagi banyak orang, baik anak-anak maupun orang dewasa di Kota Semarang.</p>
 
        </section>
       
        <section class="penyajian">
          <div>
          <Image src={pisangplenetFoto2} />
            
          </div>
          <div>
            <h1>Penyajian</h1>
            <p>Seperti namanya, pisang plenet adalah pisang yang dipelenet alias dipipihkan. Alat pemipihnya menggunakan akrilik. Setelah dipipihkan, pisang-pisang itu dibakar. Lantas diberi beraneka ragam rasa, seperti selai nanas, cokelat, gula halus, dan mentega. Pisang yang digunakan sejak tempo dulu hingga kini sama, yakni pisang kepok. Pisang kepok cocok dimasak dengan cara dibakar atau digoreng. Sebab teksturnya tidak lembek. Orang Jawa menyebutnya mengkel atau sedikit keras. </p>
          </div>
        </section>
        ...
        <section class="tersedia">
          ...
          <div class="imgTersedia2">
           ...
           <a href="/pisangplenet1">
            <Image  src={pisangplenetToko1} />
            </a>
            <a href="/pisangplenet2">
            <Image  src={pisangplenetToko2} /></a> </div>
            <br/><br/>
            <br/>
