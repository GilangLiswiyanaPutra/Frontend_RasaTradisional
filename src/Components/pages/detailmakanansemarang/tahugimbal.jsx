...
import tahugimbalFoto from '../../../assets/semarang/makanan/tahugimbal/tahugimbal1.png'
import tahugimbalFoto2 from '../../../assets/semarang/makanan/tahugimbal/tahugimbal2.png'
import tahugimbalToko1 from '../../../assets/semarang/makanan/tahugimbal/toko1.png'
import tahugimbalToko2 from '../../../assets/semarang/makanan/tahugimbal/toko2.png'
...
<div>
    ...
    <Image src={Back} />
       ...
       <Image className="imgHead3" src={tahugimbalFoto} />
      </div>
      <div class="description">
        <section>
          <div class="judul">
            <h1>Tahu Gimbal</h1><div className="nilaibintang">
          ...
          <p>Tahu Gimbal adalah hidangan khas dari Kota Semarang, Jawa Tengah, Indonesia, yang terkenal dengan cita rasa yang unik dan menggugah selera. Hidangan ini merupakan perpaduan antara tahu goreng yang disajikan dengan kuah kental yang khas dan berbagai pelengkap yang memberikan tambahan tekstur dan cita rasa.</p>
 
        </section>
       
        <section class="penyajian">
          <div>
          <Image src={tahugimbalFoto2} />
            
          </div>
          <div>
            <h1>Penyajian</h1>
            <p>Tahu gimbal adalah makanan khas Kota Semarang. Makanan ini terdiri dari tahu goreng, rajangan kol mentah, lontong, tauge, telur, dan gimbal (udang yang digoreng dengan tepung) dan dicampur dengan bumbu kacang yang khas karena menggunakan petis udang. Beda dengan saus kacang untuk pecel Madiun yang agak kental, saus bumbu kacang untuk tahu gimbal agak sedikit encer.</p>
          </div>
        </section>
        ...
        <section class="tersedia">
          ...
          <div class="imgTersedia2">
           ...
           <a href="/tahugimbal1">
            <Image  src={tahugimbalToko1} />
            </a>
            <a href="/tahugimbal2">
            <Image  src={tahugimbalToko2} /></a> </div>
            <br/><br/>
            <br/>
