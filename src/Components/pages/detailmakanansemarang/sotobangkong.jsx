...
import SotoBangkongfoto from '../../../assets/semarang/makanan/sotobangkong/sotobangkong1.png'
import SotoBangkongfoto2 from '../../../assets/semarang/makanan/sotobangkong/sotobangkong2.png'
import SotoBangkongToko1 from '../../../assets/semarang/makanan/sotobangkong/toko1.png'
...
<div>
    ...
    <Image src={Back} />
       ...
       <Image className="imgHead3" src={SotoBangkongfoto} />
      </div>
      <div class="description">
        <section>
          <div class="judul">
            <h1>Soto Bangkong</h1><div className="nilaibintang">
          ...
          <p>Soto Bangkong adalah hidangan soto yang berasal dari daerah Semarang, Jawa Tengah, Indonesia, tepatnya dari daerah Bangkong. Hidangan ini menjadi ikon kuliner yang terkenal di daerah tersebut. Soto Bangkong memiliki ciri khas tersendiri yang membedakannya dari soto-soto lainnya.</p>
 
        </section>
       
        <section class="penyajian">
          <div>
          <Image src={SotoBangkongfoto2} />
            
          </div>
          <div>
            <h1>Penyajian</h1>
            <p>Secara umum, Soto Bangkong memiliki kuah yang kental dan berwarna kuning kecokelatan, terbuat dari kaldu ayam yang kaya rempah. Daging ayam yang digunakan biasanya dipotong kecil-kecil dan dimasak hingga empuk dalam kuah yang kaya rasa. Selain daging ayam, dalam hidangan ini juga terdapat tambahan seperti telur rebus, tauge, daun bawang, dan kadang-kadang potongan kentang.</p>
          </div>
        </section>
        ...
        <section class="tersedia">
          ...
          <div class="imgTersedia2">
           ...
           <a href="/sotobangkong1">
            <Image  src={SotoBangkongToko1} />
            </a>
             </div>
            <br/><br/>
            <br/>
