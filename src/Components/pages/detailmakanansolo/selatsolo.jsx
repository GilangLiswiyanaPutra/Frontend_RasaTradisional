...
import selatsolofoto from '../../../assets/solo/makanan/selatsolo/selatsolo1.png'
import selatsolofoto2 from '../../../assets/solo/makanan/selatsolo/selatsolo2.png'
import selatsoloToko1 from '../../../assets/solo/makanan/selatsolo/toko1.png'
import selatsoloToko2 from '../../../assets/solo/makanan/selatsolo/toko2.png'
...
<div>
    ...
    <Image src={Back} />
       ...
       <Image className="imgHead3" src={selatsolofoto} />
      </div>
      <div class="description">
        <section>
          ...
          <p>Selat Solo adalah satu dari banyaknya kuliner khas Kota Surakarta yang populer di kalangan wisatawan. Di balik rasanya yang enak, rupanya makanan yang satu merupakan makanan perpaduan Eropa dan Indonesia yang disebut Bistik Jawa.</p>
 
        </section>
       
        <section class="penyajian">
          <div>
          <Image src={selatsolofoto2} />
            
          </div>
          <div>
            <h1>Penyajian</h1>
            <p>Selat Solo disajikan bersama sayuran berupa wortel dan buncis rebus, tomat, telur rebus serta daun selada. Untuk memberi rasa kenyang, selat Solo juga dilengkapi dengan kentang goreng. Di atas daun selada biasanya diberi saus mustard dan ada pula yang menambahkan acar mentimun.</p>
          </div>
        </section>
        ...
        <section class="tersedia">
          ...
          <div class="imgTersedia2">
           ...
           <a href="/selatsolo1">
            <Image  src={selatsoloToko1} />
            </a>
            <a href="/selatsolo2">
            <Image  src={selatsoloToko2} /></a> </div>
            <br/><br/>
            <br/>
