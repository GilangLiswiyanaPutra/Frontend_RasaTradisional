...
import lenjonganfoto from '../../../assets/solo/makanan/lenjongan/lenjongan1.png'
import lenjonganfoto2 from '../../../assets/solo/makanan/lenjongan/lenjongan2.png'
import lenjonganToko1 from '../../../assets/solo/makanan/lenjongan/toko1.png'
import lenjonganToko2 from '../../../assets/solo/makanan/lenjongan/toko2.png'
...
<div>
    ...
    <Image src={Back} />
       ...
       <Image className="imgHead3" src={lenjonganfoto} />
      </div>
      <div class="description">
        <section>
          ...
          <p>Lenjongan adalah jajanan pasar yang mayoritas terbuat dari singkong. Lenjongan terdiri dari berbagai makanan (Gendar, Klepon, Sawut, Jongkong, Gatot, Getuk, Tiwul, Cenil, Klepon, Ketan hitam, Ketan putih, Jagung (Grontol)), lalu ditaburi parutan kelapa dan gula pasir ataupun gula merah cair.</p>
 
        </section>
       
        <section class="penyajian">
          <div>
          <Image src={lenjonganfoto2} />
            
          </div>
          <div>
            <h1>Penyajian</h1>
            <p>Cara penyajiannya sesuai apa yang dipilih oleh pembeli kemudian atas ditaburi parutan kelapa dan ditaburi gula pasir yang halus atau pembeli ingin ditaburi gula merah cair juga bisa sesuai selera pembeli. Manis menjadi rasa dominan Lenjongan. Teksturnya kenyal, ada sedikit rasa gurih yang berasal dari kelapa parutnya. Seluruh cita rasa itu berpadu menjadi satu kesatuan bernama Lenjongan.</p>
          </div>
        </section>
        ...
        <section class="tersedia">
          ...
          <div class="imgTersedia2">
           ...
           <a href="/lenjongan1">
            <Image  src={lenjonganToko1} />
            </a>
            <a href="/lenjongan2">
            <Image  src={lenjonganToko2} /></a> </div>
            <br/><br/>
            <br/>
