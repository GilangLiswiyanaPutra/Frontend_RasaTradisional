...
import satebuntelfoto from '../../../assets/solo/makanan/satebuntel/satebuntel1.png'
import satebuntelfoto2 from '../../../assets/solo/makanan/satebuntel/satebuntel2.png'
import satebuntelToko1 from '../../../assets/solo/makanan/satebuntel/toko1.png'
import satebuntelToko2 from '../../../assets/solo/makanan/satebuntel/toko2.png'
...
<div>
    ...
    <Image src={Back} />
       ...
       <Image className="imgHead3" src={satebuntelfoto} />
      </div>
      <div class="description">
        <section>
          ...
          <p>Proses pembuatan sate buntel sangat khas. Daging kambing dicincang hingga lembut dan dicampur dengan bumbu khusus. Kemudian, daging yang telah dibumbui tersebut dibentuk ke dalam kepalan pada tusuk sate yang lebih besar dari tusuk sate biasa.</p>
 
        </section>
       
        <section class="penyajian">
          <div>
          <Image src={satebuntelfoto2} />
            
          </div>
          <div>
            <h1>Penyajian</h1>
            <p>Sate Buntel Solo disajikan dengan cara membalut potongan daging yang sudah dibumbui dengan lemak atau jeroan, kemudian dibakar hingga matang di atas bara api. Hidangan ini biasanya disajikan dengan nasi putih, lalapan, dan sambal khas Solo.</p>
          </div>
        </section>
        ...
        <section class="tersedia">
          ...
          <div class="imgTersedia2">
           ...
           <a href="/satebuntel1">
            <Image  src={satebuntelToko1} />
            </a>
            <a href="/satebuntel2">
            <Image  src={satebuntelToko2} /></a> </div>
            <br/><br/>
            <br/>
