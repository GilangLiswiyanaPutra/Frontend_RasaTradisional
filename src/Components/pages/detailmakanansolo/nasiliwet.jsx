...
import nasiliwet from '../../../assets/solo/makanan/nasiliwet/nasiliwet1.png'
import nasiliwet2 from '../../../assets/solo/makanan/nasiliwet/nasiliwet2.png'
import nasiliwetToko1 from '../../../assets/solo/makanan/nasiliwet/toko1.png'
import nasiliwetToko2 from '../../../assets/solo/makanan/nasiliwet/toko2.png'
...
<div>
    ...
    <Image src={Back} />
       ...
       <Image className="imgHead3" src={nasiliwet} />
      </div>
      <div class="description">
        <section>
          ...
          <p>Nasi Liwet merupakan hidangan nasi yang khas dari Solo, Jawa Tengah, Indonesia. Di dalamnya, nasi dimasak dengan menggunakan berbagai bumbu tradisional yang kaya rempah, seperti serai, daun salam, daun jeruk, serta santan kelapa untuk memberikan cita rasa yang lezat dan gurih. Nasi liwet biasanya disajikan dalam periuk atau wadah tradisional, menambah aroma khas yang menyatu dengan rasa nasi yang legit.</p>
 
        </section>
       
        <section class="penyajian">
          <div>
          <Image src={nasiliwet2} />
            
          </div>
          <div>
            <h1>Penyajian</h1>
            <p>Selain nasi, hidangan ini juga ditemani dengan berbagai lauk pauk seperti ayam goreng, tahu goreng, tempe goreng, telur rebus, serta sayuran seperti daun singkong atau labu siam. Sambal terasi atau sambal goreng sering disediakan sebagai pendamping, memberikan tambahan rasa pedas yang menyegarkan.</p>
          </div>
        </section>
        ...
        <section class="tersedia">
          ...
          <div class="imgTersedia2">
           ...
           <a href="/nasiliwet1">
            <Image  src={nasiliwetToko1} />
            </a>
            <a href="/nasiliwet2">
            <Image  src={nasiliwetToko2} /></a> </div>
            <br/><br/>
            <br/>
