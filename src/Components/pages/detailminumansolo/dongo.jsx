...
import dongofoto from '../../../assets/solo/minuman/dongo/dongo1.png'
import dongofoto2 from '../../../assets/solo/minuman/dongo/dongo2.png'
import dongoToko1 from '../../../assets/solo/minuman/dongo/toko1.png'
import dongoToko2 from '../../../assets/solo/minuman/dongo/toko2.png'
...
<div>
    ...
    <Image src={Back} />
       ...
       <Image className="imgHead3" src={dongofoto} />
      </div>
      <div class="description">
        <section>
          ...
          <p>Wedang Dongo yaitu sebuah minuman hangat tradisional yang berasal dari Solo yang dahulu hanya dinikmati oleh keluarga kerajaan. Namun, seiring berjalannya waktu, wedang ini mulai menyebar ke lingkungan masyarakat luas.</p>
 
        </section>
       
        <section class="penyajian">
          <div>
          <Image src={dongofoto2} />
            
          </div>
          <div>
            <h1>Penyajian</h1>
            <p>Wedang dongo adalah ronde khas solo yang nikmat diseruput malam-malam, juga biasa disajikan pada upacara keagamaan. Dulunya minuman ini khusus dinikmati keluarga kerajaan.Dalam seporsi wedang dongo, bisa ditemukan racikan kacang, kolang-kaling, dan bulatan ketan berisi kacang halus yang ditumbuk seperti ronde. Bedanya, kuah wedang dongo berwarna lebih coklat dengan rasa jahe yang lebih kuat daripada wedang ronde.</p>
          </div>
        </section>
        ...
        <section class="tersedia">
          ...
          <div class="imgTersedia2">
           ...
           <a href="/dongo1">
            <Image  src={dongoToko1} />
            </a>
            <a href="/dongo2">
            <Image  src={dongoToko2} /></a> </div>
            <br/><br/>
            <br/>
