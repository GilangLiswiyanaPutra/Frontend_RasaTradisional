...
import kapalfoto from '../../../assets/solo/minuman/kapal/kapal1.png'
import kapalfoto2 from '../../../assets/solo/minuman/kapal/kapal2.png'
import kapalToko1 from '../../../assets/solo/minuman/kapal/toko1.png'
import kapalToko2 from '../../../assets/solo/minuman/kapal/toko2.png'
...
<div>
    ...
    <Image src={Back} />
       ...
       <Image className="imgHead3" src={kapalfoto} />
      </div>
      <div class="description">
        <section>
          ...
          <p>Minuman es kapal sudah berlayar di Solo sejak tahun 1950-an. Meski sudah lebih dari 50 tahun, namun es ini masih eksis dikalangan pecintanya. Biasanya, penjual es kapal menggunakan gerobak yang dapat dijumpai di pinggir jalan. Es kapal terbuat dari serutan es yang dicampur dengan santan dan susu coklat. Dalam penyajiannya, es ini disajikan bersama roti tawar yang berbentuk seperti layar kapal</p>
 
        </section>
       
        <section class="penyajian">
          <div>
          <Image src={kapalfoto2} />
            
          </div>
          <div>
            <h1>Penyajian</h1>
            <p>Minuman ini terbuat dari es serut, santan, dan sirup coklat yang dibuat dari gula jawa. Es kapal disajikan dengan sepotong roti tawar yang dicelupkan ke dalam minuman sehingga memberikan pengalaman unik. Gelas yang digunakan untuk menyajikan es kapal mirip dengan gelas tempo dulu. Penyajiannya ini semakin mempertegas bahwa Es Kapal merupakan minuman tradisional yang sudah ada sejak lama.</p>
          </div>
        </section>
        ...
        <section class="tersedia">
          ...
          <div class="imgTersedia2">
           ...
           <a href="/kapal1">
            <Image  src={kapalToko1} />
            </a>
            <a href="/kapal2">
            <Image  src={kapalToko2} /></a> </div>
            <br/><br/>
            <br/>
