...
import dawetfoto from '../../../assets/solo/minuman/dawet/dawet1.png'
import dawetfoto2 from '../../../assets/solo/minuman/dawet/dawet2.png'
import dawetToko1 from '../../../assets/solo/minuman/dawet/toko1.png'
import dawetToko2 from '../../../assets/solo/minuman/dawet/toko2.png'
...
<div>
    ...
    <Image src={Back} />
       ...
       <Image className="imgHead3" src={dawetfoto} />
      </div>
      <div class="description">
        <section>
          <div class="judul">
            <h1>Es Dawet Telasih</h1>
          ...
          <p>Berbeda dengan es dawet pada umumnya, es dawet telasih khas Solo ini disajikan dengan ketan hitam dan biji selasih. Dalam satu mangkok es dawet telasih terdapat cendol, buah nangka yang dipotong kecil, bubur sumsum, ketan hitam, dan selasih yang diberi gula aren dan disiram dengan segarnya kuah santan.</p>
 
        </section>
       
        <section class="penyajian">
          <div>
          <Image src={dawetfoto2} />
            
          </div>
          <div>
            <h1>Penyajian</h1>
            <p>Di Es Dawet Telasih Solo campurannya yaitu dawet hijau dan selasih yang menghiasi mangkuk. Dihidangkan dengan mangkuk kecil dengan sendok bebek berwarna perak. Dalam satu porsi Es Dawet Telasih, kamu akan disuguhkan campuran kuah santan, cendol, gula aren, nangka yang telah diiris, bubur sumsum, dan ketan hitam. Es dawet ini tidak menggunakan sakarin dan mengandalkan bahan-bahan alami.</p>
          </div>
        </section>
        ...
        <section class="tersedia">
          ...
          <div class="imgTersedia2">
           ...
           <a href="/dawet1">
            <Image  src={dawetToko1} />
            </a>
            <a href="/dawet2">
            <Image  src={dawetToko2} /></a> </div>
            <br/><br/>
            <br/>
